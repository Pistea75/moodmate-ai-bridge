...
export function PublicNav() {
  ...
  return (
    <div className="flex items-center justify-between py-4 px-6 bg-gradient-to-r from-purple-600/95 to-purple-700/95 backdrop-blur supports-[backdrop-filter]:bg-purple-600/90 sticky top-0 z-50 w-full border-b border-purple-400/20">
