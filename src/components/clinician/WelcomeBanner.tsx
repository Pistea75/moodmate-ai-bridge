...
export function WelcomeBanner() {
  ...
  return (
    <Card className={`${isSuperAdmin ? 'bg-gradient-to-r from-gray-900 to-gray-800 border-gray-700' : 'bg-gradient-to-r from-mood-purple to-mood-purple/80'} text-white`}>
      <CardContent className="p-6">
        <h1 className="text-2xl font-bold mb-2">
          Welcome back, {isSuperAdmin ? 'Super Admin' : 'Dr.'} {clinicianFullName}!
        </h1>
        <p className={`${isSuperAdmin ? 'text-gray-300' : 'text-mood-purple-light'}`}>
          {isSuperAdmin 
