...
export function ClinicianSidebarContent() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">{t('clinicianPortal')}</p>
            </div>
          </div>
          <ThemeToggle />
        </div>
      ...
      <div className="p-4 bg-blue-50 dark:bg-blue-950/30 border-b border-gray-200 dark:border-gray-800">
